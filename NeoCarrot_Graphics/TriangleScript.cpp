...
void TriangleScript::Awake()
{
    ...
    //
    {
        ...
        // AwakeCompileShader
        //
        hr = CompileShaderFromFile(_fxhFilename.c_str(),
                                   "VS",
                                   "vs_5_0",
...

    {
        ...
        // };
        //
        // 시멘틱 네임 / 시멘틱 인덱스 / 포멧 / 인풋슬롯 / 오프셋 / 인풋 슬롯
        // 클래스 / 인스턴스 데이터 스탭 레이트
        //
        // 시멘틱 네임
        //    대소문자를 구분하지 않습니다.
        //
        // 시멘틱 네임 인덱스
        //     "COLOR0" 및 "COLOR1"과 같이 숫자가 추가된 시맨틱 이름을 사용하는
        //     대신, 두 요소는 서로 다른 시맨틱 인덱스 0과 1을 사용하여 단일
        //     시맨틱 이름인 "COLOR"를 공유할 수 있습니다.
        //
        // 나머지 자세한 설명은
...
HRESULT TriangleScript::CompileShaderFromFile(const WCHAR* szFileName,
                                              LPCSTR szEntryPoint,
